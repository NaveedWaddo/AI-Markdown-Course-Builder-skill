...
5. **Auto-output the full updated PROGRESS-TRACKER.md after EVERY topic — no exceptions.** Never ask the user to update it manually. It is always delivered as a downloadable file right after the topic .md.
